  ...
  public: {
    Tables: {
      ...
      conversion_funnel: {
        ...
        Relationships: [
          {
            foreignKeyName: "conversion_funnel_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      revenue_analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "revenue_analytics_subscription_id_fkey"
    ...
    Views: {
      ...
      business_intelligence_summary: {
        Row: {
          app_registrations: number | null
          app_to_payment_conversion_rate: number | null
          daily_active_users: number | null
          date: string | null
          image_generations: number | null
          new_subscriptions: number | null
          quiz_completions: number | null
          quiz_conversion_rate: number | null
          quiz_starts: number | null
          quiz_to_app_conversion_rate: number | null
